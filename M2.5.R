...
for (indexi in 1:nofsimu) {
  ...
  yijdata_1st <- function(x,z,u,tbeta,talpha,tgamma,tdelta,zlast,eps) {
    lengthofz=length(z)
  ...
  ydata_1st <- function(x,z,u,tbeta,talpha,tgamma,tdelta,zlast,eps) {
    i=length(x)
    j=nrow(x[[1]])
    yall=matrix(0,i,j)
    ...
    for (k in 1:i) {
      for (l in 1:j) {
        yall[k,l]=yijdata_1st(x[[k]][l,],z[[k]][l,],u[[k]][l,],tbeta,talpha,tgamma,tdelta,zlast[[k]][l],eps[l])
      }
    }
    return (yall)
  }
  ...
  sim2 <- function(sn,nhelper1,nhelper2,nhelper3,c2,tbeta,talpha,tgamma,tdelta) {
    ...
    while (si<=sn) {
      ...
      for (i in (nhelper1/2+1):nhelper1) {
        ...
        zlast_1sthelperm_temp[[1]]=zlast_1sthelperm[[i]]
        u_1sthelperm_temp[[1]]=u_1sthelperm[[i]]
        y_1sthelperm[[i]]=ydata_1st(x_1sthelperm_temp,z_1sthelperm_temp,u_1sthelperm_temp,tbeta,talpha_1st[[i]],tgamma_1st[[i]],tdelta_1st[[i]],zlast_1sthelperm_temp,eps_1sthelperm[[i]])
      }
